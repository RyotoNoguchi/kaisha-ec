...
export function HeaderMenu({ menu, primaryDomainUrl, viewport }: { menu: HeaderProps['header']['menu']; primaryDomainUrl: HeaderQuery['shop']['primaryDomain']['url']; viewport: Viewport }) {
