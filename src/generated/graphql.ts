...
export function useProductVariantsQuery(
  baseOptions: Apollo.QueryHookOptions<ProductVariantsQuery, ProductVariantsQueryVariables> & ({ variables: ProductVariantsQueryVariables; skip?: boolean } | { skip: boolean })
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useProductVariantsSuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<ProductVariantsQuery, ProductVariantsQueryVariables>) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useSuspenseQuery<ProductVariantsQuery, ProductVariantsQueryVariables>(ProductVariantsDocument, options)
}
...
export type ProductVariantsSuspenseQueryHookResult = ReturnType<typeof useProductVariantsSuspenseQuery>
