...
export const Button: React.FC<Props> = ({
  ...
  return (
    <button className={`w-max flex justify-center items-center ${borderWidth} ${borderStyle} ${borderColor} ${backgroundColor} rounded-full px-3 py-2 ${opacity}`} onClick={onClick}>
