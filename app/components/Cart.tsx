...
function CartLines({ lines, layout }: { layout: CartMainProps['layout']; lines: CartApiQueryFragment['lines'] | undefined }) {
...
function CartLineItem({ layout, line }: { layout: CartMainProps['layout']; line: CartLine }) {
...
export function CartSummary({ cost, layout, children = null }: { children?: React.ReactNode; cost: CartApiQueryFragment['cost']; layout: CartMainProps['layout'] }) {
...
function CartLinePrice({ line, priceType = 'regular', ...passthroughProps }: { line: CartLine; priceType?: 'regular' | 'compareAt'; [key: string]: any }) {
...
export function CartEmpty({ hidden = false, layout = 'aside' }: { hidden: boolean; layout?: CartMainProps['layout'] }) {
  return (
    <div hidden={hidden}>
      <br />
